...
import 'package:flutter_application_3/components/item_player_card.dart';
import 'package:flutter_application_3/models/player_card.dart';
...
final List<PlayerCard> playerCards = <PlayerCard>[
  ...
  PlayerCard(
    ...
    description:
        'оигровщик-второгодка из старшей Аобаджосай, отличающийся скверным характером и эгоистичной игрой на площадке. По состоянию на 2021 год, он играет на позиции диагонального в команде 2 дивизиона V Лиги вместе с Цукишимой.',
    photoUrl:
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return ItemPlayerCard(playerCards: playerCards[index]);
          }),
    );
  }
}